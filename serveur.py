...
class Partie:
    ...
    async def lancer_chrono(self):
        ...
        try:
            ...
            # et la vérification anti-zombie nous ferait sortir sans compter le tour
...
async def traiter_stopper_sequence(partie: Partie, joueur_id: str):
    ...
    # Protection contre stoppages répétés
    ...
    # Marquer comme joué immédiatement pour éviter tout doublon
